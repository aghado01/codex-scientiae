...
The stochastic orderingof probabilitymeasuresprovidesa techniquewhichis fundamental to the study of random-cluster measures. Let E be a finite or countably infinite set, let = {0,1}E, and let F be the σ-field generated by the cylinder eventsof . In applicationsof the argumentsof this section, E will be the edge-set of a graph, and thus we refer to members of E as ‘edges’, although the graphical structure is not itself relevant at this stage.
...
Proof of Theorem 2.1. The theorem amounts to a ‘mere’ numerical inequality involving a finite number of positive reals. It may in principle be proved in a totally elementary manner, using essentially no general mechanism. The proof given here proceeds by constructing certain reversible Markov chains. There is some extra mechanismrequired, butthe methodis beautiful, and in additionyields a structure which ﬁnds applications elsewhere.
...
Let E be a finite set as in the last section, and let = {0,1}E. A probability measure µ on is said to have the FKG lattice property if it satisﬁes the so-called FKG lattice condition:
...
We turn now to a consideration of the FKG lattice condition. Recall the Hamming distance between conﬁgurations defined in (1.26). A pair ω1,ω2 ∈ is called comparable if either ω1 ≤ ω2 or ω1 ≥ ω2, and incomparable otherwise.
...
Let N ≥ 1, and let E be an arbitary finite set with |E| = N. We write = {0,1}E as usual, and F for the set of all subsets of . Let µ be a probability measure on ( ,F ), and A an increasing event. The (conditional) inﬂuence on A of the edge e ∈ E is defined by
...
Let M be an integer satisfying 1 ≤ M < m. Having defined π(ei), ω(ei) for 1 ≤ i ≤ M such that π(ei) ≤ ω(ei), we deﬁne π(eM+1) and ω(eM+1) as follows. We declare
...
We shall apply Theorem 2.6, noting first that the µi are strictly positive. It sufﬁces to check (2.7), and that one of µ1, µ2 satisﬁes (2.8).
...
While one may deﬁne random-cluster measures on a broad class of infinite graphs using the methods of this chapter, we shall concentrate here on finite-dimensional lattice-graphs. We shall, almost without exception, consider the (hyper)cubic lattice Ld = (Zd,Ed) in some number d of dimensions satisfying d ≥ 2. This restriction enables a clear exposition of the theory and open problems without suffering the complications that arise through allowing greater generality. We note however that many of the basic properties of random-clustermeasures on lattices are valid on a much larger class of graphs. Interesting further questions arise in the non-finite-dimensional setting of non-amenable graphs, to which we return in Section 10.12.

There are two ways of deﬁning random-cluster measures on an infinite graph G = (V, E). The first is to consider weak limits of measures on finite subgraphs , in the limit as ↑ V. This will be discussed in Section 4.3, following the
...
Let = {0,1}Ed, and let F be the σ-field generated by the cylinder subsets of . Since is a partially ordered set, we may speak of ‘increasing’ events and random variables. Given two probability measures µ1, µ2 on ( ,F ), we write µ1 ≤st µ2 if
...
- (4.6) Proposition. Let E be a countable set, let = {0,1}E, and let F be the σ-field generatedby the cylindersubsets of . Let µ1, µ2 be probabilitymeasures on ( ,F ) such that µ1 ≤st µ2. Then µ1 = µ2 if and only if
...
Stochastic inequalities and positive association are conserved by weak convergence, in the following sense. (4.10) Proposition. Let E be a countable set, let = {0,1}E, and let F be the σ-field generated by the cylinder subsets of .
...
- Proof of Lemma 4.14. The key to the proof is positive association, which is valid by Theorem 3.8 when q ∈ [1,∞). The proof is straightforward,if slightly tedious when written out in detail. Since p and q will be held constant, we omit them from future subscripts. Let q ∈ [1,∞) and let be a finite subset of Zd. For ξ ∈ and for any increasing continuous function X : → R, we deﬁne the increasing random variable Xξ : → R by
...
(4.15) definition. Let p ∈ [0,1] and q ∈ (0,∞). A probability measure φ on ( ,F ) is called a limit-random-cluster measure with parameters p and q if, for
...
for sequences = ( n) of boxes and (ξn) of conﬁgurations. This provides no extra generality over definition 4.15, as we explain next in two paragraphs which the reader may choose to omit, [152].
...
Let G = (V, E) be a countable, locally finite3 graph, and write E = {0,1}E, and FE for the σ-field generated by the cylindersubsets of E. An automorphism of G is a bijection τ : V → V such that, for all u,v ∈ V, u,v ∈ E if and only if
...
(4.29) definition. Let p ∈ [0,1] and q ∈ (0,∞). A probability measure φ on ( ,F ) is called a DLR-random-cluster measure with parameters p and q if: (4.30)

for all A ∈ F and boxes , φ(A | T )(ξ) = φ ,ξ p,q(A) for φ-a.e. ξ. The set of such measures is denoted by Rp,q.

Theconditionofthisdefinitionamountstothe following. Supposewe aregiven that the conﬁguration off the finite box is that of ξ ∈ . Then, for almost every ξ, the (conditional) measure on is the finite-volume random-cluster measure

φ ,ξ p,q. It is not difﬁcult to see, by a calculation of conditional probabilities, that no further generality may be gained by replacing the finite box by a general finite subset of Zd. Indeed, we shall see in Proposition 4.37(b) that it sufﬁces to have (4.30) for all pairs = {x, y} with x ∼ y.

The structure of Rp,q relative to the set Wp,q remains somewhat obscure. It is not known, for example, whether or not Wp,q ⊆ Rp,q, and indeed one needs some work even to demonstrate that Rp,q is non-empty. The best result in this direction to date is restricted to probability measures having a certain additional property. For ω ∈ , let I(ω) be the number of infinite open clusters of ω. We say that a probability measure φ on ( ,F ) has the 0/1-infinite-cluster property5 if φ(I ∈ {0,1}) = 1.
...
(4.39) Lemma [152]. Let φ be a probability measure on ( ,F ) with the finiteenergy property (4.32) and the 0/1-infinite-cluster property. For any box and any cylinder event A ∈ F , the random variable g(ω) = φ ,ω p,q(A) is φ-almostsurely continuous.
...
(b) Let φ satisfy (4.38) for all e ∈ E, and let be a finite box. For φ-almost-every ξ ∈ , the conditional measure µξ(·) = φ(· | T )(ξ) may be thought of as a probability measure on the finite set = {0,1}E with an appropriate boundary
...
subject to the constraint that σx = 1 for all x ∈ ∂ . It is standard that the limits in (4.89)–(4.90) exist. Probably the easiest proof of this is to couple the Potts model with a random-cluster model on the same graph, and to use the stochastic monotonicity of the latter to prove the existence of the infinite-volume limit.
...
The Potts modelhas a usefulpropertycalled ‘reﬂection-positivity’. It is natural to ask whether a similar property is satisfied by general random-cluster measures. It was shown in [43] that the answer is negative for non-integer values of the parameter q.
...
Let W be a finite subset of Zd and, for ω ∈ , deﬁne the vector τW(ω) = (τw(ω) : w ∈ W). By Theorem 1.13(a), for n sufficiently large that W ⊆ n, (4.94)
...
By the definition of τ(ω∞), the edge e = x, y satisﬁes ω∞(e) = 0 whenever τx(ω∞) = τy(ω∞). Let ei = xi, yi , i = 1,2,. . .,n, be a finite collection of distinct edges, and let D be the subset of × given by
...
Let G = (V, E) be a finite graph, with = {0,1}E as usual. Let p ∈ (0,1) and q ∈ (0,∞). We shall construct a reversible Markov chain in continuous time having as unique invariant measure the random-cluster measure φp,q on . A feature of the Glauber dynamics of this section is that the set of permissible jumps comprises exactly those in which the state of a single edge, e say, changes. To this end, we recall first the notation of (1.25). For ω ∈ and e ∈ E, let ωe and ωe be the conﬁgurationsobtainedby ‘switching e on’ and‘switching e off’, respectively.
...
As usual, G = (V, E) is a finite graph, typically a large box in Zd, and we let q ∈ {2,3,. . .}. Consider a q-state Potts model on G, with state space = {1,2,. . .,q}V and parameter β ∈ (0,∞). The corresponding random-cluster model has state space = {0,1}E and parameter p = 1 − e−β. The Swendsen– Wang evolution for the Potts model is as follows.
...
Let e = x, y ∈ Ed. As in (8.35), let Pe be the set of all paths of Ed \ {e} that join x to y. Let Qe be the set of all pairs α = (α1,α2,. . .), β = (β1,β2,. . . ) of vertex-disjointsemi-infinite paths (where αi and βj are the vertices of these paths) with α1 = x and β1 = y; we require αi = βj for all i, j. Thus Qe comprises pairs (α,β) of paths and, for ω ∈ , we call an element (α,β) of Qe open if all the edges of both α and β are open.
...
which implies (8.75). We deduce as required that λ = F(e,ν). (b) Let e = x, y ∈ Ed. Suppose ν ∈ X0 and ν ↑ ν as ↑ Zd. We prove first that the increasing limit
...
One of the key facts for supercritical percolation is the (almost-sure) uniqueness of the infinite open cluster, which may be stated in the following form. Let φp be the percolation (product) measure on = {0,1}Ed where d ≥ 2. We have that:
...
Let be a finite subset of V, and let E be the set of edges of T having both endvertices in . For ξ ∈ = {0,1}E, we write ξ for the (finite) subset of
...
For which p, q is there a unique wired random-cluster measure on the binary tree T? We assume for simplicity that q ∈ [1,∞). By Theorem 10.82, R1p,q = {φπ} whenever p is sufficiently small that φp1,q(0 ↔ ∞) = 0. The last holds if and only if
...
where π = p/[p + q(1 − p)]. The recipe is as follows. Let x be a vertex of T other than its root. The set Rx of x-rays constitutes an infinite binary tree denoted by Tx = (Vx, Ex) with root x (the vertex x has degree 2 in Tx). Let ex denote the unique edge of T with endvertex x and not belonging to Tx, and let Ex′ = Ex ∪ {ex}. Let µx be the measure on ( ,F ) given by:
...
Let G = (V, E) beaninfinite, connected,locallyfinite, transitivegraph, andlet = {0,1}E. As usual, for F ⊆ E, we write FF for the σ-field generated by the

states of edges in F, TF = FE\F, and F for the σ-field generated by the finite-dimensional cylinders. The tail σ-field is T = F TF where the intersection is over all finite subsets F of E. A probability measure µ on ( ,F ) is called tail-trivial if µ(A) ∈ {0,1} for all A ∈ T .
...
for e = x, y . Here, as in (10.71), Je is the event that e is open, Te is the σ-field generated by states of edges other than e, and π = p/[p+q(1− p)]. In addition,
...
(10.102) Proposition [242]. Let G be an infinite connected locally finite graph that is transitive and unimodular, and let µ be an Aut(G)-ergodic probability measure on ( ,F ) that is positively associated and insertion-tolerant. Then µ(I = 1) = 1 if and only if
...
given i ∈ {1,2,. . .,q}, in which case we write π ,β,i q. The symbol U will be used to denote the σ-field generated by the spins (σy : y ∈/ \ ∂ ).

(11.2)definition. Aprobabilitymeasure π on ( ,G) iscalled a Gibbsstate ofthe q-state Potts model with inverse-temperature β if it satisﬁes the DLR condition:
...
Consider the lattice Ld with d ≥ 2. The spin space is = {A, B,C, D}Zd, and G denotes the σ-field of generated by the cylinder events. In order to deﬁneAshkin–Tellermeasuresontheinfinite lattice, wefollowthestandardrecipe outlined in the last section around definition 11.2. For τ ∈ and a box , one may deﬁne an Ashkin–Teller measure α ,βτ on with boundary condition τ. A probabilitymeasure α on( ,G) is called a Gibbsstate of the Ashkin–Tellermodel with inverse-temperature β if, for any box , the conditional measure on , given the conﬁguration τ off \ ∂ , is α ,βτ .
...
The relevant graphical method makes uses the following edge-model. Let G = (V, E) be a finite graph as before, and take as conﬁguration space the set
...
If β ∈ I, the edgesof type 1/2 dominate a supercriticalproductmeasure, and those oftype2aredominatedbyasubcriticalproductmeasure. Therefore,β1 ≤ β ≤ β2, and hence I is a sub-interval of [β1,β2], implying that β1 < β2. We may indeed ﬁnd such an interval I if J2/J1 is sufficiently large.
...
Consider now the infinite lattice Ld where d ≥ 2, and let = {0,1,2}Zd, endowed with the usual σ-field G. We may deﬁne a Gibbs state in the manner given above: a probability measure µ on ( ,G) is called a lattice (WR-)Gibbs state if it satisﬁes the appropriate DLR condition.
...
7. So far we had got only a first indication about a relationship between the systems A–C and the Potts model. We then wanted to turn to more general situations. We had observed that (for arbitrary G) certain characteristic quantities in A–C, such as

(A) the total current flowing through an electric network when a unit potential
...
9. Now if in the Potts model we have p(e) = 0, i.e. w(e) = 1, for some edge e, this means that J(e) = 0; this is equivalent to having an interaction graph G with the edge e deleted. Similarly, p(e) = 1, w(e) = 0, means that the interaction is infinitely strong; this is equivalent to having an interaction graph with the edge e contracted (i.e. deleted and its end points identiﬁed). If DeG and CeG, respectively, are the graphs thus obtained from G, then obviously,
...
So far about history. Looking at the subsequent developments, I am somewhat surprised by the fact that (to my knowledge) no one has given any attention to the domain of q between 0 and 1, not even to the limit in which one recovers the electric network,where life becomesmuch simpler. Of course,the FKGinequality does not hold in this domain, but does that imply that nothing of interest can be done? I admit that Fortuin was the first to restrict himself to the region where FKG holds, but that was because the time for his PhD research was limited! In fact, if I remember correctly, some mathematician once published a paper in which a graph-theoretical interpretation was given to the random-cluster model (probably under the name of dichromatic polynomial) for q = −1 (or q = −2, I am not sure).
...
I remember especially the first time he [Piet] told me about his ideas (end of 1966 when I still was doing my military service and he already had invited me to work withhim): weweresittingnexteachotheratthetableinfrontofthewindow,which he used for working sessions, and he explained his ideas (the ABC of the letter) while I was listening. My first work was then ‘putting the electrical current of a network into the scheme’. The actual formulating of the model took some time: I guess that it was end 1968/begin 1969 before on my blackboard the formula with 2n appeared (the reformulation of the Ising model); I then went to his ofﬁce and said something like: “I have found what we sought” (but half and half expecting he would say that he already knew!). We walked back to my ofﬁce where he overlooked the blackboard and remarked that this was a special moment(!).
...
∂eD 174 The 1-edge-boundary of the edge-set D ∂extF 147 Set of vertices of VF in infinite paths of the complement
...
15 The space {0,1}E of conﬁgurations F 16 The σ-field of generated by the cylinders F 16 The σ-field generated by states of edges in E T 16 The σ-field generated by states of edges in Ed \ E T 16 The tail σ-field
...
- adjacency: [15](#sec-1-6)
- admissibility: [211](#sec-7-9)
- alarm clock: [226](#sec-8-3), [232](#sec-8-6), [254](#sec-8-8)
- altitude: [210](#sec-7-9)
- amenability: [315](#sec-10-12)
- anti-ferromagnet: [333](#sec-11-5), [347](#appendix-fkg)
- Ashkin–Teller model: [2](#sec-1-1), [20](#sec-2-1), [326](#sec-11-3), [346](#appendix-fkg)
- A.–T. random-cluster model: [327](#sec-11-3)
- Gibbs state for A.-T. model: [326](#sec-11-3)

- automorphism: [41](#sec-3-3), [74](#sec-4-3), [315](#sec-10-12), [162](#sec-6-6)
  - acting transitively: [41](#sec-3-3)
  - a.-invariance: [302](#ch-10)
  - a. with infinite orbit: [316](#sec-10-12)
  - group: [74](#sec-4-3), [315](#sec-10-12)

- base: [210](#sec-7-9)
- Blume–Capel(–Potts) model: [323](#sec-11-2)
- Boel–Kasteleyn inequalities: [266](#ch-9)
- boundary: [17](#sec-1-6)
  - 1-edge-b.: [174](#sec-7-3)
  - edge-b.: [17](#sec-1-6)
  - external edge-b.: [174](#sec-7-3)
  - internal edge-b.: [174](#sec-7-3)
  - upper/lower b.: [197](#sec-7-6)
  - vertex-b.: [174](#sec-7-3)

- boundary conditions: [70](#sec-4-2), [237](#sec-8-7), [299](#ch-10)
  - free, wired b. c.: [71](#sec-4-2), [301](#ch-10)

- box: [18](#sec-1-6), [301](#ch-10)
- crossings on square lattice: [137](#sec-6-1)
- bubble condition: [275](#sec-9-4)
- c-plaquette: [208](#sec-7-9)
- Cardy formula: [164](#sec-6-7)
- Cayley graph: [316](#sec-10-12)

- ceiling: [208](#sec-7-9)
- chessboard estimate: [179](#sec-7-4)
- chromatic polynomial: [347](#appendix-fkg)
- circuit: [17](#sec-1-6)
- closed edge: [3](#sec-1-1), [4](#sec-1-2), [15](#sec-1-6)
- closure of set of plaquettes: [170](#sec-7-2)
- cluster: [17](#sec-1-6)
- cluster-weighting factor: [3](#sec-1-1)
- co-connected set: [177](#sec-7-3)
- comparison inequalities: [43](#sec-3-4), [77](#sec-4-3)
- complement: [16](#sec-1-6)
- complete graph: [277](#sec-10-2)
- configuration: [15](#sec-1-6)
  - frustrated: [334](#sec-11-5)
  - (in)comparable c.: [26](#sec-2-2)
  - maximum, minimum c.: [20](#sec-2-1)
  - partial order: [16](#sec-1-6)

- conformal field theory: [165](#sec-6-7)
- connected subgraph: [13](#sec-1-5)
- connective constant: [145](#sec-6-4)
- connectivity function: [11](#sec-1-4)
  - exponential decay of c. f.: [112](#sec-5-4)

- continuous random variable: [19](#sec-2-1)
- contour: [173](#sec-7-3)
  - compatible c.: [177](#sec-7-3)
  - externally-compatible c.: [177](#sec-7-3)
  - free/wired c.: [175](#sec-7-3)

- convexity: [56](#ch-3)
- co-rank of subgraph: [258](#sec-9-1)
- correlation
  - c./connection theorem: [11](#sec-1-4)
  - c. function: [11](#sec-1-4)
  - c. length: [115](#ch-5)

- coupling: [20](#sec-2-1), [226](#sec-8-3)
  - c. from the past: [227](#sec-8-4)
  - c. of random-cluster and Potts models: [8](#sec-1-4), [95](#sec-4-6)

- critical exponent: [273](#sec-9-3), [275](#sec-9-4), [296](#sec-10-8)
- critical point: [99](#sec-5-1)
  - for uniqueness of infinite cluster: [318](#sec-10-12)
  - Lipschitz continuity of c. p.: [99](#sec-5-1)
  - of complete graph: [278](#sec-10-2)
  - of hexagonal lattice: [162](#sec-6-6)
  - of inhomogeneous square lattice: [155](#sec-6-6)
  - of triangular lattice: [162](#sec-6-6)
  - of square lattice: [138](#ch-6)
  - of tree: [306](#sec-10-10)

- slab critical point: [124](#sec-5-7)
- cubic lattice: [18](#sec-1-6)
- Curie point: [6](#sec-1-3)
- cutset: [194](#sec-7-5), [301](#ch-10)
- cycle: [17](#sec-1-6)
- cylinder function, event: [15](#sec-1-6)

- decreasing event, random variable: [16](#sec-1-6), [19](#sec-2-1), [236](#sec-8-6)

- degree
  - d. of spanning set: [43](#sec-3-4)
  - d. of vertex: [58](#sec-3-7)

- detailed balance equations: [224](#sec-8-2)
- dichromatic polynomial: [53](#ch-3)
- discrete Fourier transform: [30](#sec-2-3)
- disjoint-occurrence property: [64](#ch-3)
- disordered Potts ferromagnet: [330](#sec-11-4)
- DLR-random-cluster-measure: [78](#sec-4-4), [302](#ch-10)

- Dobrushin
  - boundary condition: [197](#sec-7-6)
  - interface: [195](#sec-7-6)

- edge
  - co-connected set: [177](#sec-7-3)
  - contraction/deletion of e.: [37](#sec-3-1), [346](#appendix-fkg)
  - e.-boundary: [17](#sec-1-6)
  - e.-transitivity: [153](#ch-6)
  - in parallel/series: [62](#ch-3), [307](#sec-10-10), [342](#appendix-fkg)

- edge-negative-association: [63](#ch-3)
- Edwards–Anderson spin-glass model: [333](#sec-11-5)
  - Gibbs state for E.–A. model: [335](#sec-11-5)
  - uniqueness of Gibbs states: [335](#sec-11-5)

- electrical network: [15](#sec-1-6), [66](#ch-3), [342](#appendix-fkg)
  - parallel/series laws: [342](#appendix-fkg)

- equator: [197](#sec-7-6)
- equivalence relation: [299](#ch-10), [300](#ch-10)
  - measurability of e. r.: [302](#ch-10)

- Erdos–R˝ enyi´ random graph: [278](#sec-10-2), [299](#ch-10)
- event
  - A-invariant e.: [34](#sec-2-4)

- exploration process: [165](#sec-6-7)
- exponential alarm clock: [226](#sec-8-3), [232](#sec-8-6)
- exponential decay
  - of radius: [112](#sec-5-4), [113](#ch-5), [125](#sec-5-7)
  - in two dimensions: [143](#ch-6)
  - of volume: [119](#sec-5-6)

- exponential-steepness theorem: [36](#sec-2-5), [49](#ch-3)
- externally compatible contours: [177](#sec-7-3)

- Feller process: [244](#sec-8-8), [252](#sec-8-8)
- ferromagnetism: [7](#sec-1-3)
- finite-energy property: [36](#sec-2-5), [38](#sec-3-1), [73](#sec-4-3), [79](#sec-4-4), [80](#sec-4-4), [111](#sec-5-4)
  - positive f. e.: [256](#sec-8-9)

- first-order phase transition: [144](#sec-6-4), [182](#sec-7-5)
  - in two dimensions: [145](#sec-6-4)

- FK representation: [3](#sec-1-1)
- FKG
  - inequality: [25](#sec-2-2), [341](#appendix-fkg), [347](#appendix-fkg)
  - strong FKG: [27](#sec-2-2)
  - lattice condition/property: [25](#sec-2-2)

- flow
  - f. polynomial: [258](#sec-9-1)
  - mod-q f.: [258](#sec-9-1)

- forest: [13](#sec-1-5)
- four-colour problem: [347](#appendix-fkg)
- free contour: [175](#sec-7-3)
- frustrated configuration: [334](#sec-11-5)

- Gaussian free field: [166](#sec-6-7)
- Gibbs sampler: [222](#sec-8-1), [223](#sec-8-1), [225](#sec-8-3), [227](#sec-8-4)
  - coupled: [232](#sec-8-6)

- Gibbs state: [7](#sec-1-3), [124](#sec-5-7), [183](#sec-7-5)
  - for Ashkin–Teller model: [326](#sec-11-3)
  - for Edwards–Anderson model: [335](#sec-11-5)
  - for Potts model: [322](#sec-11-2)
  - for Widom–Rowlinson model: [338](#sec-11-6)

- Glauber dynamics: [6](#sec-1-3), [222](#sec-8-1), [224](#sec-8-2)
- graph: [15](#sec-1-6)
  - amenable g.: [315](#sec-10-12)
  - Cayley g.: [316](#sec-10-12)
  - complete g.: [277](#sec-10-2)
  - directed g.: [257](#sec-9-1)
  - edge-transitive g.: [153](#ch-6)
  - even g.: [262](#ch-9)
  - locally finite g.: [74](#sec-4-3)
  - (quasi-)transitive g.: [315](#sec-10-12)
  - unimodular g.: [315](#sec-10-12)

- graphical methods: [320](#sec-11-1)
- Hamiltonian: [7](#sec-1-3)
- Hammersley–Simon–Lieb inequality: [266](#ch-9)
- Hamming distance: [16](#sec-1-6)
- harmonic explorer: [166](#sec-6-7)
- heat-bath algorithm: [223](#sec-8-1), [225](#sec-8-3)
- height: [210](#sec-7-9)
- Heisenberg model: [8](#sec-1-4)
- hexagonal lattice: [154](#sec-6-6)
- Holley inequality: [20](#sec-2-1)
- hull: [164](#sec-6-7)
- hypercontractivity: [30](#sec-2-3)

- increasing event, random variable: [16](#sec-1-6), [19](#sec-2-1), [236](#sec-8-6)
- indicator function: [15](#sec-1-6)
- influence
  - i. of edge: [30](#sec-2-3)
  - i. theorem: [30](#sec-2-3)

- insertion tolerance: [38](#sec-3-1), [318](#sec-10-12)
  - uniform i.-t.: [111](#sec-5-4)

- interface: [201](#sec-7-7)
  - extended i.: [201](#sec-7-7)
  - localized i.: [218](#ch-7)
  - regular i.: [201](#sec-7-7)
  - semi-extended i.: [208](#sec-7-9)
  - vertical displacement of i.: [219](#ch-7)

- Ising model: [1](#sec-1-1), [6](#sec-1-3), [57](#sec-3-7), [115](#ch-5), [138](#ch-6), [195](#sec-7-6), [223](#sec-8-1), [260](#sec-9-1), [273](#sec-9-3), [343](#appendix-fkg)
  - on tree: [314](#sec-10-11)
  - with real-valued interactions: [333](#sec-11-5)

- isoperimetric constant: [315](#sec-10-12)
- Kirchhoff theorem: [15](#sec-1-6), [66](#ch-3)
- lace expansion: [274](#sec-9-4)
- large deviations: [53](#ch-3), [298](#sec-10-8)
- lattice: [18](#sec-1-6), [152](#ch-6)
  - cubic l.: [18](#sec-1-6)
  - hexagonal l.: [154](#sec-6-6)
  - labelled l.: [162](#sec-6-6)
  - square l.: [133](#sec-6-1)
  - triangular l.: [154](#sec-6-6)

- lattice gas
  - Potts l. g.: [323](#sec-11-2)
  - Widom–Rowlinson l. g.: [337](#sec-11-6)

- level-set process: [232](#sec-8-6), [234](#sec-8-6), [241](#sec-8-8)
- Lieb inequality: [268](#ch-9)
- limit random-cluster measure: [72](#sec-4-3)
- local moves: [224](#sec-8-2)
- localization: [218](#ch-7)
- loop-erased random walk: [165](#sec-6-7)

- Markov chain: [21](#sec-2-1), [45](#sec-3-4), [224](#sec-8-2)
  - reversible M. c.: [21](#sec-2-1), [224](#sec-8-2)

- martingale method: [241](#sec-8-8)
- mass gap: [145](#sec-6-4), [182](#sec-7-5), [267](#ch-9), [270](#ch-9)
- mean-field
  - bound: [273](#sec-9-3)
  - theory: [276](#sec-10-1)

- mixing property: [75](#sec-4-3), [317](#sec-10-12)
- mod-q flow: [258](#sec-9-1)
- monotonic measure: [27](#sec-2-2)
- Monte Carlo Markov chain: [222](#sec-8-1)

- n-vector model: [8](#sec-1-4)
- negative association: [63](#ch-3)
- non-translation-invariant measures: [199](#sec-7-7)
- normalizing constant: [4](#sec-1-2)

- O(n) model: [8](#sec-1-4)
- one-point specification: [317](#sec-10-12)
- open
  - cluster: [17](#sec-1-6)
  - edge: [3](#sec-1-1), [4](#sec-1-2), [15](#sec-1-6)

- origin: [18](#sec-1-6)
  - of group of standard walls: [211](#sec-7-9)
  - of standard wall: [211](#sec-7-9)

- parallel/series laws: [62](#ch-3), [307](#sec-10-10), [342](#appendix-fkg)
- partial order: [16](#sec-1-6), [19](#sec-2-1), [234](#sec-8-6)
- partition function: [4](#sec-1-2), [53](#ch-3)
  - convexity of p. f.: [56](#ch-3)

- path: [16](#sec-1-6)
- Peierls estimate: [181](#sec-7-4)
- percolation
  - model: [2](#sec-1-1), [4](#sec-1-2), [343](#appendix-fkg)
  - p. probability: [98](#sec-5-1)
  - continuity of p. p.: [102](#sec-5-2)
  - phase transition: [98](#sec-5-1)
  - first/second order p. t.: [144](#sec-6-4)
  - in two dimensions: [145](#sec-6-4)

- Pirogov–Sinai method: [182](#sec-7-5)
- planar
  - duality: [133](#sec-6-1), [137](#sec-6-1)
  - graph: [133](#sec-6-1)

- plaquette: [168](#sec-7-1), [169](#sec-7-2)
  - c-plaquette: [208](#sec-7-9)
  - horizontal, vertical p.: [201](#sec-7-7)
  - s-connectivity: [168](#sec-7-1), [169](#sec-7-2)
  - w-plaquette: [208](#sec-7-9)

- Poisson random graph: [259](#sec-9-1)
- polymer: [174](#sec-7-3), [179](#sec-7-4)
- positive association: [25](#sec-2-2), [39](#sec-3-2), [69](#sec-4-1), [73](#sec-4-3), [80](#sec-4-4)
  - strong p.-a.: [27](#sec-2-2)

- Potts lattice gas: [323](#sec-11-2)
- Potts model: [1](#sec-1-1), [6](#sec-1-3), [102](#sec-5-2), [183](#sec-7-5), [222](#sec-8-1), [223](#sec-8-1), [231](#sec-8-5), [257](#sec-9-1), [321](#sec-11-2)
  - anti-ferromagnetic P. m.: [347](#appendix-fkg)
  - disordered P. ferromagnet: [330](#sec-11-4)
  - Gibbs state for P. m.: [322](#sec-11-2)
  - on complete graph: [278](#sec-10-2)
  - on infinite graph: [95](#sec-4-6)

- pressure: [86](#sec-4-5), [175](#sec-7-3), [284](#ch-10), [295](#sec-10-7), [297](#sec-10-8)
  - convexity of p.: [86](#sec-4-5)

- probability measure
  - 1-monotonic p. m.: [27](#sec-2-2)
  - A-invariant p. m.: [34](#sec-2-4)
  - automorphism-invariance: [302](#ch-10)
  - edge-negative-association: [63](#ch-3)
  - ergodicity: [74](#sec-4-3)
  - finite-energy property: [79](#sec-4-4)
  - invariant p. m.: [74](#sec-4-3)
  - mixing property: [75](#sec-4-3), [317](#sec-10-12)
  - monotonic p. m.: [27](#sec-2-2)
  - positively associated p. m.: [25](#sec-2-2), [39](#sec-3-2)
  - strictly positive p. m.: [20](#sec-2-1)
  - tail-triviality: [75](#sec-4-3), [316](#sec-10-12)
  - translation-invariant p. m.: [75](#sec-4-3)

- product measure: [4](#sec-1-2), [263](#ch-9)
- quantum spin systems: [321](#sec-11-2)
- quasilocality: [79](#sec-4-4)

- radius: [110](#sec-5-4)
  - exponential decay of r.: [112](#sec-5-4), [113](#ch-5), [125](#sec-5-7)

  - in two dimensions: [143](#ch-6)

- random graph: [4](#sec-1-2), [278](#sec-10-2), [299](#ch-10)
- random interactions: [330](#sec-11-4)

- random variable
  - continuous r. v.: [19](#sec-2-1)
  - decreasing r. v.: [16](#sec-1-6)
  - increasing r. v.: [16](#sec-1-6)
  - invariant r. v.: [74](#sec-4-3)
  - semicontinuity: [68](#sec-4-1)
  - translation invariance: [75](#sec-4-3)

- random-cluster measure: [4](#sec-1-2)
  - automorphism invariance: [75](#sec-4-3)
  - box crossings when d = 2: [137](#sec-6-1)
  - comparison inequalities: [43](#sec-3-4), [77](#sec-4-3)
  - conditional measures: [37](#sec-3-1)
  - differential formulae: [41](#sec-3-3), [199](#sec-7-7)
  - DLR measure: [78](#sec-4-4)
  - domination by Ising measure: [59](#sec-3-7)
  - ergodicity: [75](#sec-4-3)
  - exponential steepness: [49](#ch-3)
  - extremality: [75](#sec-4-3), [80](#sec-4-4), [302](#ch-10)
  - limit measure: [72](#sec-4-3)
  - mixing property: [75](#sec-4-3), [317](#sec-10-12)
  - nesting property: [70](#sec-4-2)
  - non-translation-invariant measure: [199](#sec-7-7)
  - parallel/series laws: [62](#ch-3), [307](#sec-10-10)
  - positive association: [39](#sec-3-2)
  - site-r. c. measure: [338](#sec-11-6)
  - tail-triviality: [75](#sec-4-3)
  - uniqueness: [107](#sec-5-3)
  - in two dimensions: [138](#ch-6)
  - when q < 1: [131](#sec-5-8)

- random-cluster model: [346](#appendix-fkg)
  - on complete graph: [277](#sec-10-2)
  - critical case: [282](#sec-10-3)
  - critical exponent: [296](#sec-10-8)
  - critical point: [278](#sec-10-2)
  - large deviations: [298](#sec-10-8)
  - largest component: [286](#sec-10-5)
  - pressure: [284](#ch-10), [295](#sec-10-7), [297](#sec-10-8)
  - subcritical case: [281](#sec-10-3)
  - supercritical case: [281](#sec-10-3)
  - on lattice: [67](#sec-4-1), [70](#sec-4-2)
  - on non-amenable graph: [315](#sec-10-12)
  - critical point for uniqueness: [318](#sec-10-12)
  - multiplicity of phases: [319](#sec-10-12)
  - on tree: [299](#ch-10)
  - critical point: [306](#sec-10-10)
  - (non-)uniqueness of measures: [277](#sec-10-2), [313](#sec-10-11)
  - percolation probability: [307](#sec-10-10)

- random-current representation: [260](#sec-9-1), [273](#sec-9-3)
- rank
  - (co-)r. of subgraph: [258](#sec-9-1)
  - r.-generating function: [53](#ch-3), [258](#sec-9-1)

- ray: [299](#ch-10)
- Rayleigh principle: [66](#ch-3)
- reflection-positivity: [96](#sec-4-6)
- Reimer inequality: [64](#ch-3)
- roughening transition: [197](#sec-7-6)
- Russo formula: [33](#sec-2-4)

- s-connectedness: [168](#sec-7-1), [169](#sec-7-2), [175](#sec-7-3)
- self-dual point: [108](#sec-5-3), [135](#sec-6-1)
- semicontinuity: [68](#sec-4-1), [77](#sec-4-3)
- series/parallel laws: [62](#ch-3), [307](#sec-10-10), [342](#appendix-fkg)
- sharp threshold theorem: [34](#sec-2-4), [42](#sec-3-3)
- Simon inequality: [265](#ch-9)
- simultaneous uniqueness: [256](#sec-8-9)
- site-random-cluster measure: [338](#sec-11-6)
- slab critical point: [124](#sec-5-7)
- SLE: [15](#sec-1-6), [164](#sec-6-7)

- spanning
  - s. subgraph: [13](#sec-1-5)
  - s. tree: [13](#sec-1-5)
  - s. vertex-set: [43](#sec-3-4)

- spin-glass model: [333](#sec-11-5)
  - Gibbs state for E.–A. model: [335](#sec-11-5)
  - on tree: [314](#sec-10-11)
  - uniqueness of Gibbs states: [335](#sec-11-5)

- splitting set: [170](#sec-7-2)
- sprinkling lemma: [50](#ch-3)
- square lattice: [133](#sec-6-1)
- stabilizer: [315](#sec-10-12)
- standard wall: [210](#sec-7-9)
  - admissible family of s. walls: [211](#sec-7-9)
  - group of s. walls: [211](#sec-7-9)

- star–triangle transformation: [62](#ch-3), [159](#sec-6-6)
- Stigler’s Law: [6](#sec-1-3)
- stochastic Lowner¨ evolution: [15](#sec-1-6), [164](#sec-6-7)
- stochastic ordering: [19](#sec-2-1), [68](#sec-4-1), [71](#sec-4-2), [80](#sec-4-4)
- Strassen theorem: [20](#sec-2-1)
- subcritical phase: [110](#sec-5-4)
- supercritical phase: [122](#sec-5-7)
- susceptibility: [273](#sec-9-3)
- Swendsen–Wang algorithm: [222](#sec-8-1), [230](#sec-8-5)

- switching lemma: [264](#ch-9)
- τ-functional: [180](#sec-7-4)
- tail
  - σ-field: [16](#sec-1-6), [316](#sec-10-12)
  - t.-triviality: [75](#sec-4-3), [316](#sec-10-12)

- thermodynamic limit: [18](#sec-1-6)
- Thomson/Dirichlet principle: [66](#ch-3)
- time-constant: [114](#ch-5)
  - positive t.-c.: [115](#ch-5)

- transitive
  - edge-t. graph: [153](#ch-6)
  - t. action: [34](#sec-2-4), [41](#sec-3-3)
  - t. graph: [41](#sec-3-3), [315](#sec-10-12)

- translation: [75](#sec-4-3)
- triangle condition: [274](#sec-9-4)
- triangular lattice: [154](#sec-6-6), [164](#sec-6-7)
- Tutte polynomial: [53](#ch-3), [257](#sec-9-1), [258](#sec-9-1)
- two-point function: [11](#sec-1-4)

- uniform connected subgraph (UCS): [13](#sec-1-5), [64](#ch-3)
- spanning tree (UST): [2](#sec-1-1), [3](#sec-1-1), [13](#sec-1-5), [65](#ch-3), [165](#sec-6-7), [166](#sec-6-7)
- (spanning) forest (USF): [13](#sec-1-5), [64](#ch-3)

- uniqueness
  - u. of infinite open cluster: [123](#sec-5-7), [318](#sec-10-12)
  - simultaneous u.: [256](#sec-8-9)
  - u. of random-cluster measure: [107](#sec-5-3)
  - in two dimensions: [138](#ch-6)
  - when q < 1: [131](#sec-5-8)

- unimodularity: [315](#sec-10-12)
- w-plaquette: [208](#sec-7-9)
- wall: [208](#sec-7-9)
  - standard w.: [210](#sec-7-9)

- Whitney polynomial: [53](#ch-3), [258](#sec-9-1)
- Widom–Rowlinson lattice gas: [337](#sec-11-6)
  - Gibbs state for W.–R. model: [338](#sec-11-6)
  - lattice model: [338](#sec-11-6)

- wired contour: [175](#sec-7-3)
- Wulff crystal: [122](#sec-5-7), [126](#sec-5-7)

- zero/one-infinite-cluster property: [79](#sec-4-4)
