...
In the example of Fig. 1 we defined neighbors as pairs of points whose Voronoi cells [19] have a common boundary. We set nearest-neighbor interactions according to equation (2):
