...
![Figure 2: Common structure of DR functions. Given the data X ∈ $\mathbb{R}^{n \times p}$ and parameters including the target dimension d , a DR function returns an embedding Y ∈ $\mathbb{R}^{n \times d}$ , preprocessing information, and projection matrix if an algorithm is of linear type.](2005.11107v1_images/imageFile2.png)

Figure 2: Common structure of DR functions. Given the data $X \in \mathbb{R}^{n \times p}$ and parameters including the target dimension d , a DR function returns an embedding $Y \in \mathbb{R}^{n \times d}$ , preprocessing information, and projection matrix if an algorithm is of linear type.
