...
\tiny
\textbf{Context:} \texttt{"The text appears in a scientific discussion on how the Earth-Moon system's evolution can be explained by a dark matter field fluid model\ldots"}\\
