...
wTw. (3.79) We recognize (3.79) as being equal, up to a constant of proportionality, to the reg-

- Exercise 3.18 ularized sum-of-squares error function (3.27). We now complete the square over w giving
...
- Exercise 3.19 result for the normalization coefﬁcient of a multivariate Gaussian, giving
