...
- 3.2 ( ) Show that the matrix Φ(ΦTΦ)−1ΦT (3.103)
...
- 3.3 ( ) Consider a data set in which each data point tn is associated with a weighting factor rn > 0, so that the sum-of-squares error function becomes
