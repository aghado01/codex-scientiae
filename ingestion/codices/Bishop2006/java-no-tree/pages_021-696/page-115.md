...
- Figure 2.10 A schematic illustration of two correlated random variables z and θ, together with the regression function f(θ) given by the conditional expectation E[z|θ]. The RobbinsMonro algorithm provides a general sequential procedure for ﬁnding the root θ of such functions.
