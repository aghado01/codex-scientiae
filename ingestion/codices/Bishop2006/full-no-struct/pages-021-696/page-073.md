...
$$
\lim _ { \Delta \to 0 } \left \{ \sum _ { i } p ( x _ { i } ) \Delta \ln p ( x _ { i } ) \right \} & = - \int p ( x ) \ln p ( x ) \, d x \quad ( 1 . 1 3 ) \\ \intertext { s e r e } \text {the quantity on the right-hand side is called the differential entropy. We see }
$$
...
$$
b y & & H [ x ] = - \int p ( x ) \ln p ( x ) \, d x . & ( 1 . 1 0 4 ) \\ \text {of discrete distributions, we saw that the maximum entropy con-}
$$
