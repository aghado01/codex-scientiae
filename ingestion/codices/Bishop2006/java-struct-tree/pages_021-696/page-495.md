...
Section 2.2.1 by (B.23). As we have seen, the parameter α0 can be interpreted as the effective prior number of observations associated with each component of the mixture. If the value of α0 is small, then the posterior distribution will be inﬂuenced primarily by the data rather than by the prior.
...
µk|m0,(β0Λk)−1� W(Λk|W0,ν0) (10.40)

=

k=1

because this represents the conjugate prior distribution when both the mean and preSection 2.3.6 cision are unknown. Typically we would choose m0 = 0 by symmetry.
