...
see that the K-means algorithm corresponds to a particular nonprobabilistic limit of Section 9.4 EM applied to mixtures of Gaussians. Finally, we discuss EM in some generality.
