...
formula (6.83) for ﬁnding the mode a�N of the posterior distribution in the Gaussian process classiﬁcation model.

6.26 (�) Using the result (2.115), derive the expressions (6.87) and (6.88) for the mean

and variance of the posterior distribution p(aN+1|tN) in the Gaussian process classiﬁcation model.
