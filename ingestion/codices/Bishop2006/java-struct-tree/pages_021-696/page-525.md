...
φn. (10.181) We have obtained re-estimation equations for the three quantities q(w), q(α),
...
. (10.184) As a function of η, the Kullback-Leibler divergence then becomes
