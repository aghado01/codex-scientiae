...
Figure 2.27 (a) In the K-nearestneighbour classiﬁer, a new point, shown by the black diamond, is classiﬁed according to the majority class membership of the K closest training data points, in this case K = 3. (b) In the nearest-neighbour (K = 1) approach to classiﬁcation, the resulting decision boundary is composed of hyperplanes that form perpendicular bisectors of pairs of points from different classes.
