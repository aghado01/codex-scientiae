...
β�(zn), which, for continuous latent variables, can be written in the form cn+1β�(zn) = �

β�(zn+1)p(xn+1|zn+1)p(zn+1|zn)dzn+1. (13.99)
...
V�n+1 − Pn�JTn (13.101) where we have deﬁned
...
= N(zn−1|µn−1,Vn−1)N(zn|Azn−1,Γ)N(xn|Czn,Σ)N(zn|µ�n,V�n) cnα�(zn)
...
Exercise 13.31 between zn and zn−1 given by

cov[zn,zn−1] = Jn−1V�n. (13.104)
