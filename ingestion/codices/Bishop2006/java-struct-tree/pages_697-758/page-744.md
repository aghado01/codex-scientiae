...
Platt, J. C. (2000). Probabilities for SV machines. In A. J. Smola, P. L. Bartlett, B. Scholkopf, and¨ D. Shuurmans (Eds.), Advances in Large Margin Classiﬁers, pp. 61–73. MIT Press.

Platt, J. C., N. Cristianini, and J. Shawe-Taylor (2000). Large margin DAGs for multiclass classiﬁcation. In S. A. Solla, T. K. Leen, and K. R. Muller (Eds.),¨ Advances in Neural Information Processing Systems, Volume 12, pp. 547–553. MIT Press.
