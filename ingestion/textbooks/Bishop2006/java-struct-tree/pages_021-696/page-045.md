...
We can readily ﬁnd expectations of functions of x under the Gaussian distribuExercise 1.8 tion. In particular, the average value of x is given by
...
and hence σ2 is referred to as the variance parameter. The maximum of a distribution Exercise 1.9 is known as its mode. For a Gaussian, the mode coincides with the mean.
