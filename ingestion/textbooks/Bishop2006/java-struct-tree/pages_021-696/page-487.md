...
optimal factor q1�(z1). In doing so it is useful to note that on the right-hand side we only need to retain those terms that have some functional dependence on z1 because all other terms can be absorbed into the normalization constant. Thus we have
...
11 Λ12 (E[z2] − µ2). (10.13) By symmetry, q2�(z2) is also Gaussian and can be written as
