...
for a Ddimensional variable x, the conjugate prior distribution for the mean µ, assuming the precision is known, is again a Gaussian. For known mean and unknown precision
...
with a Gamma prior Gam(τ|a,b) and we integrate out the precision, we obtain the Exercise 2.46 marginal distribution of x in the form
