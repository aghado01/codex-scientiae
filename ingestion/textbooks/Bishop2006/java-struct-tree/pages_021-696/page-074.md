...
Appendix D Using the calculus of variations, we set the derivative of this functional to zero giving p(x) = exp
...
The Lagrange multipliers can be found by back substitution of this result into the Exercise 1.34 three constraint equations, leading ﬁnally to the result
