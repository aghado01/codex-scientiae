...
which is called the conditional entropy of y given x. It is easily seen, using the Exercise 1.37 product rule, that the conditional entropy satisﬁes the relation
