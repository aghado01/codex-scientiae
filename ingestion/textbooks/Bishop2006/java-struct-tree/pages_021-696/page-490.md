...
We now introduce conjugate prior distributions for µ and τ given by p(µ|τ) = N �

µ|µ0,(λ0τ)−1�

(10.22) p(τ) = Gam(τ|a0,b0) (10.23)

where Gam(τ|a0,b0) is the gamma distribution deﬁned by (2.146). Together these Section 2.3.6 distributions constitute a Gaussian-Gamma conjugate prior distribution.
