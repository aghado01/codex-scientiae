...
we note that an � 0 and �an � 0 are both required because these are Lagrange multipliers. Also µn � 0 and µ�n � 0 together with (7.59) and (7.60), require an � C and �an � C, and so again we have the box constraints
