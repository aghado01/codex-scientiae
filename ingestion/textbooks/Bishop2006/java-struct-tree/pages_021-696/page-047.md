...
Maximizing (1.54) with respect to µ, we obtain the maximum likelihood solution Exercise 1.11 given by
...
Exercise 1.12 with parameters µ and σ2. It is straightforward to show that E[µML] = µ (1.57) E[σML2 ] = �
