...
or feature extraction, to the original data variables. If the original variables comprise the vector x, then the features can be expressed in terms of the basis functions {φj(x)}.
...
s � (3.5) where σ(a) is the logistic sigmoid function deﬁned by
