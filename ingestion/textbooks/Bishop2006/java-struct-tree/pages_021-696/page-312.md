...
Section 12.3 component analysis in order to develop a nonlinear variant of PCA (Scholkopf¨ et al., 1998). Other examples of kernel substitution include nearest-neighbour classiﬁers and the kernel Fisher discriminant (Mika et al., 1999; Roth and Steinhage, 2000; Baudat and Anouar, 2000).
...
For recent textbooks on kernel methods, see Scholkopf and Smola (2002), Her-¨ brich (2002), and Shawe-Taylor and Cristianini (2004).
