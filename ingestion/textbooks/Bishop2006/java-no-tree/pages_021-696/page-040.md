...
- Exercise 1.5 in terms of the expectations of f(x) and f(x)2 var[f] = E[f(x)2] − E[f(x)]2. (1.39)
...
- Exercise 1.6 dent, then their covariance vanishes. In the case of two vectors of random variables x and y, the covariance is a matrix
