...
p(x) = N x|µ,Λ−1 (2.99) p(y|x) = N y|Ax + b,L−1 (2.100)
...
(2.101) and then consider the log of the joint distribution
...
−LA L . (2.104) The covariance matrix is found by taking the inverse of the precision, which can be
