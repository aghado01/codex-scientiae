...
wj(τ) = {1 − (1 − ρηj)τ}w j (5.197)

where wj = wTuj, and uj and ηj are the eigenvectors and eigenvalues, respectively, of H so that

Huj = ηjuj. (5.198)

Show that as τ → ∞, this gives w(τ) → w as expected, provided |1 − ρηj| < 1. Now suppose that training is halted after a ﬁnite number τ of steps. Show that the
