...
lnσ(ξn) − ξn/2 − λ(ξn)(φTnE[wwT]φn − ξn2) + const
...
(ξnnew)2 = φTnE[wwT]φn = φTn SN + mNmTN φn (10.163) where we have used (10.156).
