...
min{1,exp(−H(R ) + H(R))}. (11.69) It is easily seen that the two probabilities (11.68) and (11.69) are equal, and hence

exp(−H(R ))δV

- Exercise 11.17 detailed balance holds. Note that this proof ignores any overlap between the regions R and R but is easily generalized to allow for such overlap.
