...
- Exercise 5.11 {ui}, the contours of constant E are ellipses centred on the origin, as illustrated in Figure 5.6. For a one-dimensional weight space, a stationary point w will be a

minimum if

∂2E ∂w2 w

> 0. (5.40) The corresponding result in D-dimensions is that the Hessian matrix, evaluated at

- Exercise 5.12 w , should be positive deﬁnite.
