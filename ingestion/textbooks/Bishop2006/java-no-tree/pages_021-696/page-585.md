...
###### 12.1. Principal Component Analysis 565

minimize J = UISU2' subject to the normalization constraint uIU2 = 1. Using a Lagrange multiplier A2 to enforce the constraint, we consider the minimization of
