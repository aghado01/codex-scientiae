...
µa−1(1 − µ)b−1 (2.13) where Γ(x) is the gamma function deﬁned by (1.141), and the coefﬁcient in (2.13)

- Exercise 2.5 ensures that the beta distribution is normalized, so that 1
