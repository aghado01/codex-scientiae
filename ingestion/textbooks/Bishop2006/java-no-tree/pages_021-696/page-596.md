...
- Section 3.3.1 Note that this takes the same form as the equations for regularized linear regression and is a consequence of maximizing the likelihood function for a linear Gaussian


1 and is independent of x.

model. Similarly, the posterior covariance is given from (12.42) by 0-2M-
