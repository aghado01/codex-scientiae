...
p(t|w )p(w |α)(2π)M/2|Σ|1/2. (7.114) If we substitute for p(t|w ) and p(w |α) and then set the derivative of the marginal

- Exercise 7.19 likelihood with respect to αi equal to zero, we obtain
...
N ln(2π) + ln|C| + ( t)TC−1 t (7.118) where
