...
$$
\begin{smallmatrix} \text {r} & & \frac { \ x = 0 \quad \ x = 1 } { \ y = 0 \quad \begin{array} { c c c } \text {x} = 0 & \ x = 1 \\ \text {0.3} & \ 0 . 4 \\ \text {0.3} & \ 0 . 0 \end{array} \end{smallmatrix}
$$
...
$$
\max _ { x } p ( x ) = \max _ { x _ { 1 } } \dots \max _ { x _ { M } } p ( x )
$$
