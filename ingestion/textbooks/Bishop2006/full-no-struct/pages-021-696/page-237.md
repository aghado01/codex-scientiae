...
$$
A = - \nabla \ln p ( \mathcal { D } | \theta _ { MAP } ) p ( \theta _ { MAP } ) = - \nabla \nabla \ln p ( \theta _ { MAP } | \mathcal { D } ) .
$$
...
$$
\ln p ( \mathcal { D } ) \simeq \ln p ( \mathcal { D } | \theta _ { M A P } ) - \frac { 1 } { 2 } M \ln N
$$
...
$$
p ( \mathbf w ) = \mathcal { N } ( \mathbf w | m _ { 0 } , S _ { 0 } )
$$
