...
$$
p(x = 1 \mid \mathcal{D}) = \int_{0}^{1} p(x = 1 \mid \mu)p(\mu \mid \mathcal{D})\, d\mu = \int_{0}^{1} \mu p(\mu \mid \mathcal{D})\, d\mu = \mathbb{E}[\mu \mid \mathcal{D}]. \tag{2.19}
$$

Using the result (2.18) for the posterior distribution $p(\mu \mid \mathcal{D})$, together with the result (2.15) for the mean of the beta distribution, we obtain

$$
p(x = 1 \mid \mathcal{D}) = \frac{m + a}{m + a + l + b}. \tag{2.20}
$$
