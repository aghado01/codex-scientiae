...
###### sin(A − B) = cosB sinA − cosAsinB (2.183)

- Exercise 2.53 from which we obtain


θ0ML = tan−1 n sinθn n cosθn
...
Similarly, maximizing (2.181) with respect to m, and making use of I 0(m) = I1(m) (Abramowitz and Stegun, 1965), we have
