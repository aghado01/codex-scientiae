...
that the probability of $x$ falling in an inﬁnitesimal volume $\delta x$ containing the point $x$ is given by $p(x)\delta x$. This multivariate probability density must satisfy
