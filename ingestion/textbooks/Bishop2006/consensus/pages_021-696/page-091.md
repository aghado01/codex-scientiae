...
where $\Gamma(x)$ is the gamma function deﬁned by (1.141), and the coefﬁcient in (2.13) ensures that the beta distribution is normalized, so that

$$
\int_{0}^{1} \operatorname{Beta}(\mu \mid a, b)\, d\mu = 1. \tag{2.14}
$$
