...
Again we can ﬁrst determine the parameter vector $\mathbf{w}_{\text{ML}}$ governing the mean and subsequently use this to ﬁnd the precision $\beta_{\text{ML}}$ as was the case for the simple Gaussian distribution.
