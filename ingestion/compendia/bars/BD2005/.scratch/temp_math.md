...
Figure 1. log-PdG for a non-conception followed by a conception cycle from one subject. Solid lines indicate ﬁrst day of each cycle, and dashed lines indicate ovulation days.
...
Figure 2. Evaluation of algorithm performance using simulated data
...
Figure 3. log-PdG data (points) and estimated log-PdG (solid line) for a single woman. The dashed line is the estimated population mean log-PdG given her covariates.
...
Figure 4. Estimated population mean log-progesterone for a conception (thin line) and non-conception (heavy line) cycle with ovulation on day 14. Pointwise 95% credible intervals are given by the dashed lines.
...
Figure 5. Estimated population mean log-progesterone for non-conception cycles with ovulation on day 10 (thin line) and day 18 (heavy line). Pointwise 95% credible intervals are given by the dashed lines. Vertical lines indicate ovulation days.
...
Figure 6. The unnormalized marginal likelihood for a proposed model, p ( y | λ, δ,M ∗ ) and its corresponding Laplace approximation.
...
Probability of conception, midluteal PdG < 10

th percentile 0.144 [0.098,0.195] th

Probability of conception, midluteal PdG ≥ 10

percentile 0.217 [0.211,0.222]

Diﬀerence in conception probabilities
