...
**Definition 3.7 (Boundary cap of an interval).**  We define the **boundary cap** $\partial I$ of $I\in \mathbf{Int}(\mathbf{Z}^2)$ as the path obtained by concatenating $\min_{\mathbf{ZZ}}(I)$ and $\max_{\mathbf{ZZ}}(I)$ in Eqs. (3.5) and (?).
