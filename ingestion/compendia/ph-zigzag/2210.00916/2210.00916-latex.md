...
$R = \xymatrix{ &   &  &  & &\bullet \\ \bullet \ar[r] & \bullet \ar[r] & \bullet \ar[r] & \bullet \ar[r] & \bullet \ar[rd] \ar[ru] \\ &   &  &  & &\bullet}$

$S = \xymatrix{\bullet \ar@(ur,ul)}$

$T = \xymatrix{ \bullet \ar[r] & \bullet & \bullet \ar[l] \ar[r] & \bullet \ar[r] & \bullet }$
...
$\xymatrix{ &   &  &  & & K \\ K \ar[r]^{\tiny \begin{pmatrix} 1 \\ 0 \end{pmatrix}} & K^2 \ar[r]^{\text{id}_{K^2}} & K^2 \ar[r]^{(1~1)} & K \ar[r]\ar[r]^{\text{id}_K} & K \ar[rd]_{\text{id}_K} \ar[ru]^{\text{id}_K} \\ &   &  &  & & K}$
...
$$
\xymatrix{\mathbb{V}_{t(e)} \ar[r]^{\mathbb{V}_e} \ar[d]_{\varphi_{t(e)}} & \mathbb{V}_{h(e)} \ar[d]^{\varphi_{h(e)}} \\
\mathbb{W}_{t(e)} \ar[r]_{\mathbb{W}_e} & \mathbb{W}_{h(e)} }.
$$
...
$$
\xymatrix{f^{-1}(I) \ar[rr]^{\sim} \ar[rd]_{f} & & \mathbb{Y}_I \times I \ar[ld]^{p_2} \\
& \mathbb{R} &}.
$$
...
$$
\xymatrix{ \cdots \ar[r]& H_{p+1}(\mathbb{X}_\cap) \ar[r]& H_{p+1}(\mathbb{X}_{k-1})\oplus H_{p+1}(\mathbb{X}_{k+1})\ar[r] & H_{p+1}(\mathbb{X}_\cup) \ar[dll]  \\
&   H_{p}(\mathbb{X}_\cap)  \ar[r]  & H_{p}(\mathbb{X}_{k-1})\oplus H_{p}(\mathbb{X}_{k+1}) \ar[r]& H_{p}(\mathbb{X}_\cup) \ar[r]& \cdots \\
}
$$
...
![](2210.00916/diagram-14.svg)

\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt

![](2210.00916/diagram-15.svg)
...
$$
\begin{cases}
    [\mathbb{X}_1^1,\mathbb{X}_1^1]_0\leftrightarrow [\mathbb{X}_0^2,(\mathbb{X}_0^2,\mathbb{X}_1^2)]_1,\\
