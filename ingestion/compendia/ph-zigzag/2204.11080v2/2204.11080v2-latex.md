...
Subroutine **CellBoundary** in Line ? converts boundary simplices of $\sigma_i$ to a column of cell identifiers based on the map $\mathtt{cid}$. Subroutine **ConedCellBoundary** in Line ? returns boundary column for the cone of the cell identified by $\mathtt{del\_id}$.
