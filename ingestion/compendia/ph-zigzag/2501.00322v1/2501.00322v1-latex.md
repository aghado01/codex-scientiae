...
![](2501.00322v1/zigzag_cover_full.png)
...
![](2501.00322v1/bipath_arccode.png)
...
We review interleavings over $\mathbb{R}^{\mathrm{op}}\times \mathbb{R}$ and the bottleneck distance. Recall that for an $\epsilon\in [0, \infty]$, we define the *shift functor* $(\cdot)(\epsilon)\colon \ensuremath{\mathsf{vec}}^{\mathbb{R}^{\mathrm{op}}\times \mathbb{R}} \to \ensuremath{\mathsf{vec}}^{\mathbb{R}^{\mathrm{op}}\times \mathbb{R}}$ by sending $M$ to the persistence module given by $M(\epsilon)_{(x, y)} \coloneqq M_{(x-\epsilon, y+\epsilon)}$ and $M(\epsilon)_{(x, y)\to (w, z)} \coloneqq M_{(x-\epsilon, y+\epsilon)\to (w-\epsilon, z+\epsilon)}$. On morphisms $f\colon M\to N$, we set $f(\epsilon)_{(x, y)}\coloneqq f_{(x-\epsilon, y+\epsilon)}$. For every module $M$, we define a morphism $\phi^M_\epsilon\colon M\to M(\epsilon)$ by the internal maps $M_{(x, y)\to (x-\epsilon, y+\epsilon)}$. We say that two persistence modules $M, N\in\ensuremath{\mathsf{vec}}^{\mathbb{R}^{\mathrm{op}}\times \mathbb{R}}$ are *$\epsilon$-interleaved* if there exist morphisms $f\colon M\to N(\epsilon)$ and $g\colon N\to M(\epsilon)$ such that $g(\epsilon)\circ f = \phi^M_{2\epsilon}$ and $f(\epsilon)\circ g = \phi^N_{2\epsilon}$.
...
Then, the *interleaving distance* $d_{I}(M, N)$ between two persistence modules $M, N\colon$ $\mathbb{R}^{\mathrm{op}}\times \mathbb{R}\to\ensuremath{\mathsf{vec}}$ and the *bottleneck distance* $d_{B}(C, D)$ between two multisets of intervals $C$ and $D$ are given by
...
Let ${\mathbb U}$ be the subposet of $\mathbb{R}^{\mathrm{op}}\times \mathbb{R}$ given by $\Set{(a, b)\in \mathbb{R}^{\mathrm{op}}\times \mathbb{R} % \nonscript\:\vert{} \allowbreak{} \nonscript\: \mathopen{} a\leq b}$. As in [11, 10], we are interested in the following four types of intervals of ${\mathbb U}$.
...
![](2501.00322v1/blocks_zigzag.png)
...
$$
![](2501.00322v1/diagram-5.png)


\text{and}


![](2501.00322v1/diagram-6.png)
...
$$
![](2501.00322v1/diagram-7.png)


\text{and}


![](2501.00322v1/diagram-8.png)
...
![](2501.00322v1/fibered_barcodes.png)
...
$$
![](2501.00322v1/diagram-9.png)


\text{and}


![](2501.00322v1/diagram-10.png)
...
$$
![](2501.00322v1/diagram-11.png)


\text{and}


![](2501.00322v1/diagram-12.png)
...
![](2501.00322v1/Box_Example_M.png)

\quad\quad

![](2501.00322v1/Box_Example_N.png)
...
![](2501.00322v1/interval_in_CL4.png)
...
24. Shunsuke Tada. A Computation of Bipath Persistent Homology and Bipath Persistence Diagrams. Seminar presented at *Asia Pacific Seminar on Applied Topology and Geometry*, September 2024. Slides available at \urlhttps://shunsuketada1357.github.io/documents/slide2024-09-20.pdf. Recording movie available at \urlhttps://drive.google.com/drive/u/0/folders/1MB4wFxrQe6ph9hBde8CLGWiBSYZya6Pf.
