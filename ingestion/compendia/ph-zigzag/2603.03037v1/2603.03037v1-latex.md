...
![](2603.03037v1/naturalistic.png)

![](2603.03037v1/gaussian.png)

![](2603.03037v1/waves.png)

![](2603.03037v1/moving_dot.png)
...
![](2603.03037v1/neuron_coordinates_overview.png)
...
![](2603.03037v1/pairwise_xy_distances_per_zplane_draft.png)

![](2603.03037v1/neurons_per_zplane_draft.png)
...
![](2603.03037v1/fluorescence_traces_draft.png)

![](2603.03037v1/per_plane_average_trace_draft.png)
...
![](2603.03037v1/representative_landscape.png)

![](2603.03037v1/landscape_comparison_types.png)
...
| Gaussian | 0.82 | 12 |
| Waves | 0.78 | 12 |
| \cmidrule(lr){1-3} \multicolumn{3}{r}{**CV accuracy:** 0.686 $\pm$ 0.055} |  |  |
| Mouse **2-9** |  |  |
| **Class** | **F1** | **Support** |
| Naturalistic | 0.95 | 37 |
| Gaussian | 0.96 | 12 |
| Moving Dot | 0.83 | 11 |
| \cmidrule(lr){1-3} \multicolumn{3}{r}{**CV accuracy:** 0.743 $\pm$ 0.064} |  |  |
| Mouse **11-10** |  |  |
| **Class** | **F1** | **Support** |
| Naturalistic | 0.93 | 35 |
| Gaussian | 0.86 | 11 |
| Moving Dot | 0.91 | 12 |
| \cmidrule(lr){1-3} \multicolumn{3}{r}{**CV accuracy:** 0.721 $\pm$ 0.115} |  |  |
| Mouse **3-5** |  |  |
| **Class** | **F1** | **Support** |
| Naturalistic | 0.89 | 36 |
| Waves | 0.73 | 12 |
| Moving Dot | 0.82 | 12 |
| \cmidrule(lr){1-3} \multicolumn{3}{r}{**CV accuracy:** 0.672 $\pm$ 0.056} |  |  |
| Mouse **6-9** |  |  |
| **Class** | **F1** | **Support** |
| Naturalistic | 1.0 | 37 |
| Gaussian | 1.0 | 12 |
| \cmidrule(lr){1-3} \multicolumn{3}{r}{**CV accuracy:** 0.888 $\pm$ 0.064} |  |  |
...
![](2603.03037v1/class_video_confusion_matrix.png)

![](2603.03037v1/class_mice_confusion_matrix.png)

\caption{Aggregated confusion matrix for 5 train/test splits. *Left:* video type. *Right:* Mouse identity.}

## References

1. S. Saxena and J. P. Cunningham, "Towards the neural population doctrine," \hrefhttp://dx.doi.org/10.1016/j.conb.2019.02.002{*Current Opinion in Neurobiology* {\bfseries 55} (Apr., 2019) 103–111}.
...
3. J. J. DiCarlo, D. Zoccolan, and N. C. Rust, "How does the brain solve visual object recognition?" \hrefhttp://dx.doi.org/10.1016/j.neuron.2012.01.010{*Neuron* {\bfseries 73} no. 3, (Feb., 2012) 415–434}.
4. S. Chung and L. F. Abbott, "Neural population geometry: An approach for understanding biological and artificial neural networks," \hrefhttp://dx.doi.org/10.1016/j.conb.2021.10.010{*Current Opinion in Neurobiology* {\bfseries 70} (Oct., 2021) 137–144}.
5. M. G. Perich, D. Narain, and J. A. Gallego, "A neural manifold view of the brain," \hrefhttp://dx.doi.org/10.1038/s41593-025-02031-z{*Nature Neuroscience* {\bfseries 28} no. 8, (Aug., 2025) 1582–1597}.
...
7. L. Petrucco, H. Lavian, Y. K. Wu, F. Svara, V. Štih, and R. Portugues, "Neural dynamics and architecture of the heading direction circuit in zebrafish," \hrefhttp://dx.doi.org/10.1038/s41593-023-01308-5{*Nature Neuroscience* {\bfseries 26} no. 5, (May, 2023) 765–773}.
8. R. J. Gardner, E. Hermansen, M. Pachitariu, Y. Burak, N. A. Baas, B. A. Dunn, M.-B. Moser, and E. I. Moser, "Toroidal topology of population activity in grid cells," \hrefhttp://dx.doi.org/10.1038/s41586-021-04268-7{*Nature* {\bfseries 602} no. 7895, (Feb., 2022) 123–128}.
...
11. C. Brennan and A. Proekt, "A quantitative model of conserved macroscopic dynamics predicts future motor commands," \hrefhttp://dx.doi.org/10.7554/eLife.46814{*eLife* {\bfseries 8} (July, 2019) e46814}.
...
15. M. W. Reimann, M. Nolte, M. Scolamiero, K. Turner, R. Perin, G. Chindemi, P. Dłotko, R. Levi, K. Hess, and H. Markram, "Cliques of neurons bound into cavities provide a missing link between structure and function," \hrefhttp://dx.doi.org/10.3389/fncom.2017.00048{*Frontiers in Computational Neuroscience* {\bfseries Volume 11 - 2017} (2017) }. \urlhttps://www.frontiersin.org/journals/computational-neuroscience/articles/10.3389/fncom.2017.00048.
...
17. P. Turishcheva, P. G. Fahey, L. Hansel, R. Froebe, K. Ponder, M. Vystrčilová, K. F. Willeke, M. Bashiri, E. Wang, Z. Ding, A. S. Tolias, F. H. Sinz, and A. S. Ecker, "The dynamic sensorium competition for predicting large-scale mouse visual cortex activity from videos," 2024. \urlhttps://arxiv.org/abs/2305.19654.
...
19. L. J. Hubert and P. Arabie, "Comparing partitions," *Journal of Classification* {\bfseries 2} (1985) 193–218. \urlhttps://api.semanticscholar.org/CorpusID:189915041.
