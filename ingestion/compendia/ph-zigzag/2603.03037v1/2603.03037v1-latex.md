...
[figure (pdf): neuron_coordinates_overview.pdf](2603.03037v1/neuron_coordinates_overview.pdf)
...
[figure (pdf): pairwise_xy_distances_per_zplane_draft.pdf](2603.03037v1/pairwise_xy_distances_per_zplane_draft.pdf)

[figure (pdf): neurons_per_zplane_draft.pdf](2603.03037v1/neurons_per_zplane_draft.pdf)
...
[figure (pdf): fluorescence_traces_draft.pdf](2603.03037v1/fluorescence_traces_draft.pdf)

[figure (pdf): per_plane_average_trace_draft.pdf](2603.03037v1/per_plane_average_trace_draft.pdf)
...
[figure (pdf): representative_landscape.pdf](2603.03037v1/representative_landscape.pdf)

[figure (pdf): landscape_comparison_types.pdf](2603.03037v1/landscape_comparison_types.pdf)
...
[figure (pdf): class_video_confusion_matrix.pdf](2603.03037v1/class_video_confusion_matrix.pdf)

[figure (pdf): class_mice_confusion_matrix.pdf](2603.03037v1/class_mice_confusion_matrix.pdf)
...
6. R. Chaudhuri, A. S. Ger{\c{s}}hon, and H. Sompolinsky, "Intrinsic dimensionality of behavioral and neural representations," *Annual review of neuroscience* {\bfseries 42} (2019) 381–410.
7. L. Petrucco, H. Lavian, Y. K. Wu, F. Svara, V. {\v S}tih, and R. Portugues, "Neural dynamics and architecture of the heading direction circuit in zebrafish," \href{http://dx.doi.org/10.1038/s41593-023-01308-5}{*Nature Neuroscience* {\bfseries 26} no. 5, (May, 2023) 765–773}.
...
10. C. Fortunato, J. {Bennasar-V{á}zquez}, J. Park, J. C. Chang, L. E. Miller, J. T. Dudman, M. G. Perich, and J. A. Gallego, "Nonlinear manifolds underlie neural population activity during behaviour," Apr., 2024.
