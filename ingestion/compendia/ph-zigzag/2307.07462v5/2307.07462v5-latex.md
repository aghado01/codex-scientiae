...
![](2307.07462v5/out-expn-adj-chng.png)
...
![](2307.07462v5/in-expn-adj-chng.png)
...
![](2307.07462v5/two-tri-0.png)

![](2307.07462v5/two-tri-1.png)

![](2307.07462v5/two-tri-2.png)

![](2307.07462v5/two-tri-3.png)
...
![](2307.07462v5/fzz-out-contrac.png)
...
**Definition 4.** For each  addition or deletion $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta}$ in $\tilde{\mathcal{U}}$ s.t. $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta} \not\in \{ \mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\sigma_2},\,\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\chi},\,\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\chi}, \mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\sigma_1} \}$, define its corresponding addition/deletion in ${\mathcal{U}}'$, denoted $\theta(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta})$, as follows: $\theta(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\sigma_1})=\,\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\sigma_0}$; $\theta(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\sigma_2})=\,\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\sigma_0}$; for any remaining $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta}$, the corresponding $\theta(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta})$ is the same.

**Proposition 7.**

Given $\mathsf{Pers}_*(\tilde{\mathcal{U}})$, one only needs to do the following to obtain  $\mathsf{Pers}_*({\mathcal{U}}')$: Ignoring the pairs $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\sigma_2},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\chi})$ and $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\chi},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\sigma_1})$ in $\mathsf{Pers}_*(\tilde{\mathcal{U}})$, for each remaining pair $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\gamma})\in\mathsf{Pers}_*(\tilde{\mathcal{U}})$, produce a corresponding pair $(\theta(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta}),\theta(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\gamma}))\in\mathsf{Pers}_*({\mathcal{U}'})$.
...
**Example.** Ignoring the two pairs without correspondence, we have the following mapping of pairs from $\mathsf{Pers}(\tilde{\mathcal{U}})$ to $\mathsf{Pers}({\mathcal{U}}')$ for the example in Figure 4 (${\xi}$ is a fixed edge in the boundary of the diamond): $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{{\xi}},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\tau_2})\mapsto(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{{\xi}},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\tau_2}), (\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\sigma_1},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\tau_1})\mapsto(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\sigma_0},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\tau_1}), (\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\tau_1},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{{\xi}})\mapsto(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\tau_1},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{{\xi}}), (\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\tau_2},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\sigma_2})\mapsto(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\tau_2},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\sigma_0})$.
...
- Construct $\tilde{\mathcal{U}}$ (as in Figure 4) by first inserting $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\sigma_2}$ and $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\chi}$ into the ascending part $\mathcal{U}'_u$ of $\mathcal{U}'$; the position of the insertion can be  derived from the position of the expansion in the original $\mathcal{F}$ and $\mathcal{F}'$. Identify $\sigma_0$ as the right-most $\Delta$-cell in $\mathcal{U}'_u$ corresponding to  $\sigma$ added before the newly inserted $\sigma_2$. Rename $\sigma_0$ as $\sigma_1$. Change the boundary cell $\sigma_0$ (renamed as $\sigma_1$) to $\sigma_2$ for those $(p+1)$-cofaces of $\sigma_0$ in  $\mathcal{U}'_u$ added after the newly inserted  ${\sigma_2}$. This finishes the construction of the ascending part of $\tilde{\mathcal{U}}$. Constructing the descending part of $\tilde{\mathcal{U}}$ is symmetric.

- Re-write the representatives for $\mathsf{Pers}_*(\mathcal{U}')$ to get the representatives for the the corresponding pairs in $\mathsf{Pers}_*(\tilde{\mathcal{U}})$ (see Proposition 7). We also  let the two extra pairs $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\sigma_2},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\chi})$ and $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\chi},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\sigma_1})$ have the representative $(\sigma_1+\sigma_2,\chi)$ and $(\chi,\sigma_1+\sigma_2)$ respectively. Details of the representative re-writing are provided in Section 5.1.
...
**$(p-1)$-pairs.** For a $(p-1)$-pair  $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\gamma})\in\mathsf{Pers}_*({\mathcal{U}'})$, we only need to re-write its representative when  the $p$-chain (denoted as $A$) in the representative contains $\sigma_0$. If $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\eta},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftrightarrow}\)}{\gamma})$ is  closed-open or  closed-closed, we replace $\sigma_0$ by $\sigma_1$ in $A$; otherwise, we replace $\sigma_0$ by $\sigma_2$ in $A$. It can be verified that the re-written representative is a valid one for the corresponding pair in $\mathsf{Pers}_*(\tilde{\mathcal{U}})$.
...
**Step I: Preprocessing.** Since $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\hat{\sigma}}$ is negative in $\mathcal{U}^+$, $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\hat{\sigma}}$ must be positive in $\mathcal{U}^+$ (if adding $\hat{\sigma}$ decreases the Betti number, then deleting $\hat{\sigma}$ must increase the Betti number). Let $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\tau},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\hat{\sigma}})$ and $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\hat{\sigma}},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\tau'})$ be pairs in $\mathsf{Pers}_*(\mathcal{U}^+)$ containing $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\hat{\sigma}}$ and $\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\hat{\sigma}}$ respectively. Also suppose that $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\tau},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\hat{\sigma}})$ has the representative $(z_*,A_*)$ and $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\hat{\sigma}},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\tau'})$ has the representative $(A_\circ,z_\circ)$. Moreover, let $\Lambda$ be the set of unsettled pairs in $\mathsf{Pers}_*(\mathcal{U}^+)$. Notice that we do not include $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\tau},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\hat{\sigma}})$ and $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\hat{\sigma}},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\tau'})$ into $\Lambda$ and so pairs in $\Lambda$ are all closed-closed.
...
![](2307.07462v5/in-contr-preproc1.png)
...
![](2307.07462v5/in-contr-preproc2.png)
...
![](2307.07462v5/in-contr-comparable.png)
...
- Form a pair $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\eta_1},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\tau'})\in\mathsf{Pers}_*(\mathcal{U}')$ with a representative $(z_1,A_1+A_\circ,z'_1+z_\circ)$, where $\hat{\sigma}\not\in A_1+A_\circ$.

- Form a pair $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\tau},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\gamma_\ell})\in\mathsf{Pers}_*(\mathcal{U}')$ with a representative $(z_\ell+z_*,A_\ell+A_*,z'_\ell)$, where $\hat{\sigma}\not\in A_\ell+A_*$.

- For each $j=1,\ldots,\ell-1$: Form a pair $(\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\rightarrow}\)}{\eta_{j+1}},\mskip-2.5mu\rotatebox[origin=c]{-45}{\({\leftarrow}\)}{\gamma_{j}})\in\mathsf{Pers}_*(\mathcal{U}')$ with a representative $(z_j+z_{j+1},A_j+A_{j+1},z'_j+z'_{j+1})$, where $\hat{\sigma}\not\in A_j+A_{j+1}$.

![](2307.07462v5/in-contr-relink.png)
...
10. Samuel Eilenberg and J. A. Zilber. Semi-simplicial complexes and singular homology. *Annals of Mathematics*, 51(3):499–513, 1950. URL: \urlhttp://www.jstor.org/stable/1969364.
