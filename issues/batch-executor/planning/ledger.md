...
| BEX-201–BEX-206 — deterministic module package; payload-source boundary; mechanical public/private host split; four-command canonical surface; private worker-budget coverage; `Compile-BatchPlan` compatibility facade; capability contract | 2026-08-05 | D12–D16 | `src/shared/batch-executor/batch-executor.psd1`; module README; 20 executor + 8 plan + 8 module-surface tests; complete shared suite 129 green. Repository-wide topology closeout remains BEX-207. |
