...
# See review in `D:\aghado01\codex-scientiae\issues\doccer\discussions\grok-doccer-expansion-review-20260802.md` and further expansion for chunker factory `D:\aghado01\codex-scientiae\issues\doccer\discussions\grok-doccer-chunking-expansion-20260802.md`
...
Let boundaries be vertices $b_0,\ldots,b_n$. An admissible candidate chunk $[b_i,b_j)$ is a directed edge $b_i \rightarrow b_j$. The adapter decides which edges are admissible and supplies their costs:

$$
E = \{(i,j) \mid i < j \land \operatorname{budget}(i,j) \land \operatorname{preservesAtoms}(i,j) \land \operatorname{domainRules}(i,j)\}.
$$
