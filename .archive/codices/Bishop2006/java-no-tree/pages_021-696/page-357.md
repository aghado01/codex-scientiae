...
p(t|y) = σ(yt). (7.46) From this we can construct an error function by taking the negative logarithm of the

- Exercise 7.6 likelihood function that, with a quadratic regularizer, takes the form N
