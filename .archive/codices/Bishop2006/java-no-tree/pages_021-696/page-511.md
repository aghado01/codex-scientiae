...
- Section 10.2.5 n q (zn). This is an example of an induced factorization. Taking the exponential of both sides, we have


###### q (zn) = h(xn,zn)g (E[η])exp E[ηT]u(xn,zn) (10.116)
...
q (η) = f(νN,χN)g(η)νN exp ηTχN (10.119) where we have deﬁned
