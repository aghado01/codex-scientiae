...
- Exercise 14.8 any well-deﬁned probabilistic model. Furthermore, the exponential error does not generalize to classiﬁcation problems having K > 2 classes, again in contrast to the
