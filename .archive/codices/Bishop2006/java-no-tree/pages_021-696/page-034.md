...
= p(Y = yj|X = xi)p(X = xi) (1.9) which is the product rule of probability.
...
- Y ”. Similarly, the quantity p(Y |X) is a conditional probability and is verbalized as “the probability of Y given X”, whereas the quantity p(X) is a marginal probability
