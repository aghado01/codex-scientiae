...
- Exercise 2.41 (2.146) is correctly normalized. The gamma distribution has a ﬁnite integral if a > 0, and the distribution itself is ﬁnite if a 1. It is plotted, for various values of a and
