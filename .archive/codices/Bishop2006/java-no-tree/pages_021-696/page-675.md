...
Although we have considered the marginal probability p(X), the same considerations apply for the predictive density p(x|X) or for conditional distributions such

- Exercise 14.1 as p(t|x,X,T).
