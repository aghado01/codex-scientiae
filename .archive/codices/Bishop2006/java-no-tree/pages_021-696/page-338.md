...
(I + CNWN)−1CN nn σ n(1 − σ n)(1 − 2σ n)

n=1

(6.92)

where σ n = σ(a n), and again we have used the result (C.22) together with the deﬁnition of WN. We can evaluate the derivative of a N with respect to θj by differentiating the relation (6.84) with respect to θj to give
