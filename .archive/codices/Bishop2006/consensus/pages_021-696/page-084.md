...
1.29 ( ) www Consider an $M$-state discrete random variable $x$, and use Jensen's inequality in the form (1.115) to show that the entropy of its distribution $p(x)$ satisfies $\text{H}[x] \leqslant \ln M$.
