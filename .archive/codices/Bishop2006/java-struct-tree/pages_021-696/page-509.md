...
−Eα[lnq(w)]w − E[lnq(α)]. (10.107) Exercise 10.27 Evaluation of the various terms is straightforward, making use of results obtained in
...
(10.109) E[lnp(α)]α = a0 lnb0 + (a0 − 1)[ψ(aN) − lnbN]
