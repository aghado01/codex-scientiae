...
which must be minimized subject to the constraints ξn � 0 and �ξn � 0 as well as (7.53) and (7.54). This can be achieved by introducing Lagrange multipliers an � 0, �an � 0, µn � 0, and µ�n � 0 and optimizing the Lagrangian
...
Using these results to eliminate the corresponding variables from the Lagrangian, we Exercise 7.7 see that the dual problem involves maximizing
