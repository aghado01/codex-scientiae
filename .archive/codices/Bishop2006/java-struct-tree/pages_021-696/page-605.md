...
12.2.l'ru":ohilislk I'CA 585

FllIure12.15 Gillbs .,,,,>p!j"lllo< Bay<lslan PCA sh<Ming plots oj Ino, versus ~eralion number br three " values. showing tr"""tions betw..... tbe th"'" moOts <A !he posterior distribution.

,-"riabl, i' gi,-,n by 1'(x) ~ N(Xlj', C) whe... now

C=WWT+'i'. (12,6~)

As with probabilistic PCA, thi, moMI is im-"ri.rrl to 'Olalions in 11><0 latent 'pace.
...
E[zoJ = GWT",-'(xn - xl E[z"z~J _ G + E[zo]E[z,,]T
...
NOie th"t thi' i' e.pre,<ed in a for'" thai in,-oh'es inycrsi"n ofmalrices "f SilO ,\ I x ,If rathe'lhan D x D (ex"",,,, for tbe D x D diagooal matrix oJ' "'hose in,-erse i.' 'ri"ial
