...
The derivatives with respect to the network output activations governing the mixExercise 5.34 ing coefﬁcients are given by

∂En ∂aπk

= πk − γk. (5.155)

Similarly, the derivatives with respect to the output activations controlling the comExercise 5.35 ponent means are given by
...
Finally, the derivatives with respect to the output activations controlling the compoExercise 5.36 nent variances are given by
