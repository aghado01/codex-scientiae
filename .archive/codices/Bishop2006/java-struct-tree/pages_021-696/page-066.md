...
E[L] = �� {y(x) − t}2p(x,t)dxdt. (1.87) Our goal is to choose y(x) so as to minimize E[L]. If we assume a completely Appendix D ﬂexible function y(x), we can do this formally using the calculus of variations to
