...
Exercise 3.16 for the conditional distribution in a linear-Gaussian model. Here we shall evaluate the integral instead by completing the square in the exponent and making use of the standard form for the normalization coefﬁcient of a Gaussian. Exercise 3.17 From (3.11), (3.12), and (3.52), we can write the evidence function in the form

p(t|α,β) = �

β 2π

�N/2 � α 2π�M/2 � exp{−E(w)} dw (3.78)
