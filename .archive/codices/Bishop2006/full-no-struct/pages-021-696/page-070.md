...
$$
H [ x ] = - 8 \times \frac { 1 } { 8 } \log _ { 2 } \frac { 1 } { 8 } = 3 \, b i t s .
$$

Now consider an example (Cover and Thomas, 1991) of a variable having 8 possible states { a,b,c,d,e,f,g,h } for which the respective probabilities are given by ( 1 2 , 1 4 , 1 8 , 1 16 , 1 64 , 1 64 , 1 64 , 1 64 ) . The entropy in this case is given by

$$
H [ x ] = - \frac { 1 } { 2 } \log _ { 2 } \frac { 1 } { 2 } - \frac { 1 } { 4 } \log _ { 2 } \frac { 1 } { 4 } - \frac { 1 } { 8 } \log _ { 2 } \frac { 1 } { 8 } - \frac { 1 } { 1 6 } \log _ { 2 } \frac { 1 } { 1 6 } - \frac { 4 } { 6 4 } \log _ { 2 } \frac { 1 } { 6 4 } = 2 \, \text {bits} .
$$
...
$$
\text {average code length} = \frac { 1 } { 2 } \times 1 + \frac { 1 } { 4 } \times 2 + \frac { 1 } { 8 } \times 3 + \frac { 1 } { 1 6 } \times 4 + 4 \times \frac { 1 } { 6 4 } \times 6 = 2 \, \text {bits}
$$
