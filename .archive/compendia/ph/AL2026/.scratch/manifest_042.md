...
```
- RAW: ```
With the formula ( 3.37 ) or ( 3.42 ), we are able to compute the maximal interval-decomposable summand of persistence modules. Let M be a persistence module over P . The maximal interval-decomposable summand of M is defined by
```
  FIX: ```
With the formula (3.37) or (3.42), we are able to compute the maximal interval-decomposable summand of persistence modules. Let \( M \) be a persistence module over \( P \). The maximal interval-decomposable summand of \( M \) is defined by
```
