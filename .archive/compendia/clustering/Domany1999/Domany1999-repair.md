...
$$
\mathcal{H}(\{S\}) = \sum_{\langle i,j \rangle} J_{ij} \left(1 - \delta_{s_i, s_j}\right) \tag{1}
$$
...
![Fig. 1: Projection of the Iris data on the plane spanned by its first two principal components.](images/imageFile1.png)
...
![Fig. 2: (a) The susceptibility as a function of temperature and (b) the size of the first biggest clusters at each temperature for the Iris data.](images/imageFile2.png)
...
![Fig. 3: Isolated letter speech hierarchy obtained by the Super-Paramagnetic method.](images/imageFile3.png)
...
![Fig. 5: Dendrogram produced by superparamagnetic clustering from the distance matrix of 90 images of 6 objects.](images/imageFile5.png)
