...
- [distributions of persistence diagrams](#distributions-of-persistence-diagrams)
...
- [Maroulas, Mike, and Oballe](#maroulas-mike-and-oballe)
- [4.2. Convergence of the Kernel Density Estimator](#4-2-convergence-of-the-kernel-density-estimator)
- [Maroulas, Mike, and Oballe](#maroulas-mike-and-oballe)
- [4.3. A Measure of Dispersion](#4-3-a-measure-of-dispersion)
...
Specifically, for data in R , we consider each feature as an element of
...
Definition 5 The bottleneck distance between two persistence diagrams D 1 and D 2 is given by
...
Definition 8 For a given random persistence diagram D and any Borel subset A of W 0: − 1 , the belief function β D is defined as
...
Definition 13 For a random persistence diagram D , a global probability density function (global pdf) f D : ∪ N ∈ N W N 0: − 1 → R must satisfy
...
Now define random diagrams D u centered at D u and D centered at D such that D = D u ∪ D . Ultimately, the global pdf of D centered at D is our kernel density.
...
where ϕ j is the pdf of the (unmodified) normal N (( b j ,d j ) ,σI ) , and W ( · ) is the indicator function for the wedge.
...
First, we separate the kernel K σ ( Z, D i ), defined in Eq. (4.6), into three portions, A i , B i , and C i , according to the upper cardinality j :
...
These assumptions (and ( A 1)) are required for the subsequent lemma, which ensures that the mean absolute bottleneck deviation (MAD) is finite.
...
Figure 11: This figure shows the distribution for each statistic we considered when comparing SNR 1 to SNR 5 . Each column represents a class, either SNR 1 or SNR 5 , and each row a particular statistic.
$$
