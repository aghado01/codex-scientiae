...
- [2.1 Tensor product spline regression model](#2-1-tensor-product-spline-regression-model)
- [2.2 Prior & posterior](#2-2-prior-posterior)
- [2.3 Extended Bayesian information criterion](#2-3-extended-bayesian-information-criterion)
...
- [4 Experiment](#4-experiment)
  ...
  - [4.1 Knot inference](#4-1-knot-inference)
  ...
  - [4.2 Manifold denoising](#4-2-manifold-denoising)
...
- [Appendix B: Additional Simulations](#appendix-b-additional-simulations)
  ...
  - [B.2 Surface Spline Regression](#b-2-surface-spline-regression)
  - [Table 4: MSE on test data of five methods in Cases 1.1–1.4](#table-4-mse-on-test-data-of-five-methods-in-cases-1-1–1-4)
  - [Table 5: MSE on test data of five methods in Cases 2.1–2.4](#table-5-mse-on-test-data-of-five-methods-in-cases-2-1–2-4)
