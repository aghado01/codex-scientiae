...
r \leftarrow \log \left ( \frac { L ( k , \xi , \beta _ { c o n d } ) } { L ( k , \xi , \beta _ { c u r r } ) } \frac { \pi ( \beta _ { c o n d } | k , \xi ) } { \pi ( \beta _ { c u r r } | k , \xi ) } \frac { \pi ^ { _ } ( \beta \_ { c u r r } | k , \xi , D a t a ) } { \pi ^ { _ } ( \beta \_ { c o n d } | k , \xi , D a t a ) } \right )
