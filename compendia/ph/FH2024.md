...
$$
M \ \colon \quad 0 \, \longleftrightarrow \, F \ \xrightarrow{( 1 \, 0 )} \, F^{2} \, \longleftrightarrow \, C \ \xrightarrow{( 0 \, 1 )} \, F \ \xrightarrow{0} \, 0,
$$

N \, \colon \quad 0 \, \longleftrightarrow \, F \, \xrightarrow { ( 1 \, 1 ) } \, F ^ { 2 } \, \longleftrightarrow \, F \, \xrightarrow { 0 } \, 0,
...
\ r k \colon \text {Int} ( P ) \to N _ { 0 }, \ \ I \mapsto \text {rank} ( M | _ { I } ) = \text {rank} ( \psi _ { M | _ { I } } ).
