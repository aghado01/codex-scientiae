...
$$
Y_{0} \times (-\infty, a_{1}] \cup_{f_{0}} Z_{1} \cup_{g_{1}} \cdots \cup_{f_{n - 1}} Z_{n} \cup_{g_{n}} Y_{n} \times [a_{n}, \infty)
$$
...
$$
\begin{aligned}
[X_{i-1}^i, X_{j-1}^j] &\leftrightarrow [a_i, a_j] && \text{for } 1 \leq i \leq j \leq n, \\
[X_{i-1}^i, X_j^j) &\leftrightarrow [a_i, a_j) && \text{for } 1 \leq i < j \leq n+1, \\
(X_i^i, X_{j-1}^j] &\leftrightarrow (a_i, a_j] && \text{for } 0 \leq i < j \leq n, \\
(X_i^i, X_j^j) &\leftrightarrow (a_i, a_j) && \text{for } 0 \leq i < j \leq n+1.
\end{aligned}
$$
