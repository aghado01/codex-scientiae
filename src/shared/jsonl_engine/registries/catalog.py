...
class RegistryCatalog:
    ...
    """
    _registry_classes: Dict[str, Type[BaseArtifactRegistry]] = {}

    @classmethod
    def register(cls, registry_cls: Type[BaseArtifactRegistry]) -> Type[BaseArtifactRegistry]:
    ...
    @classmethod
    def get_registry_class(cls, kind: str) -> Type[BaseArtifactRegistry]:
        """Retrieves a registered BaseArtifactRegistry subclass by KIND."""
    ...
    @classmethod
    def create(cls, kind: str, target_dir: str, run_id: Optional[str] = None, **kwargs) -> BaseArtifactRegistry:
